...
\begin{document}
	...
	%
	\author{ sumeeth kumar %<-this  stops a space
	}
 % <-this % stops a space
...
\begin{lstlisting}
wget https://github.com/sumeethkumar12/signal-processing/blob/main/pingala/codes/1.py
\end{lstlisting}
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\columnwidth]{pin1.1.png}
	\caption{}
\end{figure}
\item 
\begin{align}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\columnwidth]{pin1.2.png}
	\caption{}
\end{figure}
\item 
\begin{align}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\columnwidth]{pin1.3.png}
	\caption{}
\end{figure}
\item 
\begin{align}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\columnwidth]{pin1.4.png}
	\caption{}
\end{figure}
...
Run the below python code 
\begin{lstlisting}
wget https://github.com/sumeethkumar12/signal-processing/blob/main/pingala/codes/2pin.py
\end{lstlisting}
Use the following command in the terminal to run the code
\begin{figure}[ht!]
	\centering
	\includegraphics[width=\columnwidth]{pin2.2.png}
	\caption{}
\end{figure}
\item Find $X^{+}(z)$.\\
\solution:
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\columnwidth]{pin2.5.png}
	\caption{}
\end{figure}
\item Find $Y^{+}(z)$.
\\
...
\begin{lstlisting}
wget https://github.com/sumeethkumar12/signal-processing/blob/main/pingala/codes/xnyn21.py
\end{lstlisting}
\end{enumerate}
\end{document}